...
<head>
    ...
    <jsp:useBean id="resume" type="com.company.model.Resume" scope="request"/>
...
<section>
    ...
    <p>
        <c:forEach var="type" items="${resume.contacts.keySet()}">
            <jsp:useBean id="type" type="com.company.model.ContactType"/>
    ...
    <table cellpadding="8">
        <c:forEach var="entry" items="${resume.sections.entrySet()}">
            ...
            <c:forEach var="org" items="<%=((OrganisationSection) entry.getValue()).getValues()%>">
                <tr>
                    <td>
                        <c:choose>
                ...
                <c:forEach var="period" items="${org.periods}">
                    <jsp:useBean id="period" type="com.company.model.Organization.Period"/>
                    <tr>
